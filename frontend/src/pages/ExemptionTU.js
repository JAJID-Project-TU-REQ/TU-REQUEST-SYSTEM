...
function ExemptionTU() {
  // Common fields
  const [form_type] = useState("เทียบโอนรายวิชา(TU)");
  ...
  const title = "เทียบโอนรายวิชา(TU)";
    ...
    <Container maxWidth="md" sx={{ mt: 14, mb: 5 }}>
      ...
      >
        <Grid item xs={12}>
          ...
          <Typography variant="h5">กลุ่มวิชาทั่วไปมหาวิทยาลัยธรรมศาสตร์</Typography>
        </Grid>
      </Grid>
        ...
        <Typography variant='h6' sx={{ mt:1, mr: 2 , fontWeight:'bold',p:2}}>
          ...
          <Box display="flex" alignItems="center">
            ...
            <Select id="subject" name="subject" variant="outlined" onChange={event => setSubject(event.target.value)} sx={{ mt:1, borderRadius:5,width: '600px', height: '50px' }}>
              <MenuItem value="TU100">TU100</MenuItem>
              <MenuItem value="TU101">TU101</MenuItem>
              <MenuItem value="TU102">TU102</MenuItem>
              <MenuItem value="TU103">TU103</MenuItem>
              <MenuItem value="TU106">TU106</MenuItem>
            </Select>
          </Box>
        </Grid>
            ...
            <Grid item xs={12} sx={{ mt: 3 }}>
              <Typography variant="h6" sx={{ fontWeight: "bold" }}>
                แนบไฟล์ผลคะแนนการสอบ TU GREATS (PDF)
              </Typography>
              <Box
                sx={{
                  mt: 1,
