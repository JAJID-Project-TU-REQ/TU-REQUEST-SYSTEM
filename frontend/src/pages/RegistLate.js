...
function RegistLate() {
  // Common fields
  const [form_type] = useState("จดทะเบียนวิชาล่าช้ากรณีพิเศษ");
  ...
  const title = "จดทะเบียนวิชาล่าช้ากรณีพิเศษ";
      ...
      >
        <Grid item xs={12}>
          <Typography variant="h4" sx={{ fontWeight: 600 }}>
            คำร้องจดทะเบียนวิชาล่าช้ากรณีพิเศษ
          </Typography>
        </Grid>
      </Grid>
